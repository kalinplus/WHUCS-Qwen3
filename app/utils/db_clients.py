...
log.info(f"Initializing Redis connection pool for host {settings.REDIS_HOST}")
try:
    ...
    log.critical(f"Failed to initialize Redis connection pool. Exiting. Error: {e}", exc_info=True)
    raise